...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/coffee.png', // Example image source
      productName: 'Nespresso VertuoPlus Deluxe Coffee and Espresso Maker by De\'Longhi Titanium', // Example product name
      price: 990, 
      numItems: numItems,
