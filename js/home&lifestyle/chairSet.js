...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/chairSet.png', // Example image source
      productName: 'Set of 4 / 6 Dining Chairs Padded Seat High back Metal Legs Home Furniture', // Example product name
      price: 990, 
      numItems: numItems,
