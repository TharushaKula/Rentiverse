...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/juice.png', // Example image source
      productName: 'Omega Juicer Cold Press 365 Vertical Slow Masticating Extractor', // Example product name
      price: 990, 
      numItems: numItems,
