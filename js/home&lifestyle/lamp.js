...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/floorLamp.png', // Example image source
      productName: 'Wooden Floor Lamp with Shelves Standard Shelf - Lounge Light', // Example product name
      price: 990, 
      numItems: numItems,
