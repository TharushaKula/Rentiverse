...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/dining.png', // Example image source
      productName: 'Classic Solid Wooden Dining Table and 4 Chairs Set Kitchen Home', // Example product name
      price: 990, 
      numItems: numItems,
