...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/grill.png', // Example image source
      productName: 'Searing Grill & Griddle extra Large Ceramic Nonstick by CRUXGG 500°F', // Example product name
      price: 2100, 
      numItems: numItems,
