...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/light.png', // Example image source
      productName: 'Dar Lexington Tempered Glass & Black Large Ceiling Pendant Light', // Example product name
      price: 990, 
      numItems: numItems,
