...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/tables.png', // Example image source
      productName: 'Set 6 Masters style Lounge Kitchen Dining Chair Garden Outdoor Indoor', // Example product name
      price: 2500, 
      numItems: numItems,
