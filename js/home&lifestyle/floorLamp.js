...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/lamp.png', // Example image source
      productName: 'Antique Vintage Wooden Tripod Stand For Floor lamp Home Decor Item', // Example product name
      price: 990, 
      numItems: numItems,
