...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/fan.png', // Example image source
      productName: 'Portable Fan For Dewalt 20V MAX Li-Ion Battery DCB200 Cordless', // Example product name
      price: 900, 
      numItems: numItems,
