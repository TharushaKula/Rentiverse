...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/ice.png', // Example image source
      productName: 'Countertop Ice Maker Self-Cleaning Scoop Basket Ice Machine', // Example product name
      price: 990, 
      numItems: numItems,
