...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/shelf.png', // Example image source
      productName: '4 Tier Wooden Bookcase Shelving Display Shelves Storage Unit Wood Shelf', // Example product name
      price: 990, 
      numItems: numItems,
