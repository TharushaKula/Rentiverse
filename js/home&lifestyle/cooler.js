...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Home and Life Style/cooler.png', // Example image source
      productName: 'Portable Mini Air Conditioner Personal Cooling Bedroom Fan', // Example product name
      price: 990, 
      numItems: numItems,
