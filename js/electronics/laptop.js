...
const selectedItem = {
    imageSrc: 'Images/Electronics/laptop.png', // Example image source
    productName: 'Certified Refurbished Apple MacBook Pro 13" Retina Core i7 16GB 1TB SSD', // Example product name
    price: 2400, 
    numItems: numItems,
