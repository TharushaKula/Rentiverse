...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Electronics/camera.png', // Example image source
      productName: 'Canon EOS 3000D 18MP 18-55mm <br> f/3.5-5.6 Lens DSLR Camera', // Example product name
      price: 1900, 
      numItems: numItems,
