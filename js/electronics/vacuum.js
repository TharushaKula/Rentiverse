...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Electronics/vaccum.png', // Example image source
      productName: 'RoboVav 25C Robotic Vaccuum Cleaner Wi-Fi Smart Automatic Sweeper Robot', // Example product name
      price: 1900, 
      numItems: numItems,
