...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Electronics/ps5.png', // Example image source
      productName: 'PlayStation 5 Console - Includes PS5 Console And DualSense Controller', // Example product name
      price: 1900, 
      numItems: numItems,
