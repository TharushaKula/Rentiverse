...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Electronics/iceMaker.png', // Example image source
      productName: 'Ice Cube Maker Machine 2.2L Electric Automatic Portable Geepas', // Example product name
      price: 1900, 
      numItems: numItems,
