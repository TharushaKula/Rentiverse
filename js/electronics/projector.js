...
function showPopup() {
  ...
  const selectedItem = {
      imageSrc: 'Images/Electronics/projector.png', // Example image source
      productName: 'Samsung The Freestyle SP-LSBP3L Smart Beam Projector FHD 550', // Example product name
      price: 1900, 
      numItems: numItems,
